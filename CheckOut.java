...
b5=new JButton("CHECKOUT");
b5.setBounds(900,510,180,30);
b5.setBackground(new Color(255,51,153));
b5.setForeground(Color.black);
b7=new JButton("GET-PDF");
b7.setBackground(new Color(255,51,153));
b7.setForeground(Color.black);
b7.setBounds(700,510,180,30);
b6=new JButton();
b6.setBounds(550,200,200,200);
		ImageIcon img2 = new ImageIcon("pay.gif");
		b6.setIcon(img2);
...
t5= new JTextField();
t5.setBounds(950,430,100,30);
t7= new JTextField();
t7.setBounds(950,360,100,30);
t8= new JTextField();
t8.setBounds(950,200,100,30);
t9= new JTextField();
t9.setBounds(950,280,100,30);
...
add(b1); add(b2); add(t2);add(t3);add(t4);add(t5);add(l1);add(l2);add(l3);add(l4);
add(l5);add(t7);add(l7);add(l8);
add(l9);add(t7);add(t8);add(t9);add(b3);add(b4);add(b5);add(b6);add(roomno);add(b7);
}
public void pdf()
{ 
try{/* Create Connection objects */
                ...
                PdfWriter.getInstance(my_pdf_report, new FileOutputStream("pdf_Checkout.pdf"));
                my_pdf_report.open();            
				...
				my_pdf_report.add(Chunk.NEWLINE);
					...
					my_pdf_report.add(new Paragraph("Checkout is Successful!!"));
					my_pdf_report.add(new Paragraph("Thanks for visiting and welcome back!!"));	
